...
public class NewFemurBehaviourScript : MonoBehaviour
{
    ...
    public Rigidbody rb_fem;
    public bool isMoving;
    // Start is called before the first frame update
    void Start()
    {
        rb_fem = GetComponent<Rigidbody>();
    }
    ...
    public void  setAngles()
    {
        ...
        rb_fem.transform.rotation = rotationY * rotationX * rotationZ;
    }
}
